...
export default AddPosts = () => {
    ...
    const handleSubmit = async () => {
        try{
            ...
            const fileRef = storage().ref().child(`/Posts/${result.id}/${imageName}`);
            ...
            () => {
                ...
                const userDocRef = firestore().collection("Posts").doc(result.id);
                userDocRef.update({
    ...
    return (
        <SafeAreaView style={theme == "light" ? lightStyles.SafeAreaView : darkStyles.SafeAreaView}>
            ...
            <View style={theme == "light" ? lightStyles.formArea : darkStyles.formArea}>
                ...
                <Pressable style={theme == "light" ? lightStyles.title : darkStyles.title}><Text style={theme == "light" ? lightStyles.titleText : darkStyles.titleText}>Add Posts</Text></Pressable>
