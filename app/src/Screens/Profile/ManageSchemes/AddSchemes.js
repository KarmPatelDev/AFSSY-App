...
export default AddSchemes = () => {
    ...
    const handleSubmit = async () => {
        try{
            ...
            const result = await firestore().collection("Schemes").add({
                "title": title,
            ...
            const fileRef = storage().ref().child(`/Schemes/${result.id}/${imageName}`);
            ...
            () => {
                ...
                const userDocRef = firestore().collection("Schemes").doc(result.id);
                userDocRef.update({
    ...
    return (
        <SafeAreaView style={theme == "light" ? lightStyles.SafeAreaView : darkStyles.SafeAreaView}>
            ...
            <View style={theme == "light" ? lightStyles.formArea : darkStyles.formArea}>
                ...
                <Pressable style={theme == "light" ? lightStyles.title : darkStyles.title}><Text style={theme == "light" ? lightStyles.titleText : darkStyles.titleText}>Add Schemes</Text></Pressable>
