...
export default LikedAgroPosts = () => {
    ...
    return(<>
        <SafeAreaView style={theme == "light" ? lightStyles.SafeAreaView : darkStyles.SafeAreaView}>
            ...
            <Pressable style={theme == "light" ? lightStyles.title : darkStyles.title}><Text style={theme == "light" ? lightStyles.titleText : darkStyles.titleText}>Liked Agro Posts</Text></Pressable>
                            ...
                            return (<View key={post.id}>
                            {
                                ...
                                <Pressable key={post.id} style={theme == "light" ? lightStyles.postContainer : darkStyles.postContainer}>
                                    <View style={theme == "light" ? lightStyles.post : darkStyles.post}>
                                        ...
                                        <View style={theme == "light" ? lightStyles.postEdit : darkStyles.postEdit}>
...
const defaultStyles = StyleSheet.create({
    ...
    postEdit: {flexDirection: "row", justifyContent: "space-between", marginTop: 10},
